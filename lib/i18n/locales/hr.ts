const hr = {
  ...
  hero: {
    ...
    removeNotes: "Ukloni napomene",
    selectVehicleType: "Odaberite tip vozila",
    vehicleOptions: {
      sedan: "do 4 osobe (sedan)",
  ...
  fleet: {
    ...
    features: {
      ...
      professionalDriver: "Profesionalni vozač",
      ...
      airportMeetGreet: "Doček u zračnoj luci",
      complementaryWater: "Besplatna voda",
      extraSpace: "Dodatni prostor",
      executiveExperience: "Izvršno iskustvo",
