const pl = {
  ...
  hero: {
    title: "Twoja Premium",
    titleHighlight: "Usługa Taxi",
    subtitle:
      "Doświadcz komfortowego i niezawodnego transportu w całej Dalmacji, od Novalji i Jezior Plitwickich po Zadar, Split i Dubrownik.",
    needRide: "Potrzebujesz przejazdu?",
    pickupLocation: "Miejsce odbioru",
    destination: "Miejsce docelowe",
    checkAvailability: "Sprawdź dostępność",
    messageTemplate:
      "Cześć! Chciałbym zarezerwować przejazd:\n\nZ: {{pickup}}\nDo: {{destination}}",
    addNotes: "Dodaj notatki",
    removeNotes: "Usuń notatki",
    selectVehicleType: "Wybierz typ pojazdu",
    vehicleOptions: {
      sedan: "do 4 osób (sedan)",
  ...
  fleet: {
    ...
    vehicles: {
      sedan: {
        name: "Standardowy Sedan",
        description:
          "Komfortowa i elegancka opcja dla maksymalnie 4 pasażerów.",
      },
      shuttle: {
        name: "Shuttle",
        description:
          "Przestronny Mercedes shuttle, idealny dla grup lub rodzin.",
      },
      luxury: {
        name: "Luksus Wykonawczy",
        description:
          "Premium doświadczenie z najwyższej klasy pojazdami i usługą.",
      },
    },
    features: {
      airConditioning: "Klimatyzacja",
      professionalDriver: "Profesjonalny kierowca",
      ...
      airportMeetGreet: "Powitanie na lotnisku",
      complementaryWater: "Darmowa woda",
      extraSpace: "Dodatkowa przestrzeń",
      executiveExperience: "Doświadczenie wykonawcze",
  ...
  contact: {
    ...
    info: {
      ...
      hours: "Godziny pracy",
      hoursValue: "24/7, 365 dni w roku",
    },
    form: {
      name: "Imię",
      message: "Wiadomość",
  ...
  testimonials: {
    ...
    subtitle:
      "Przeczytaj opinie naszych zadowolonych klientów o ich doświadczeniu z naszym serwisem taxi.",
    roles: {
      tourist: "Turysta",
    },
  },
